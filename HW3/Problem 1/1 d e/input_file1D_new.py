...
def inputfile():
  ...
  # Reservoir parameters    
    ...
    TAO[numerical.N-1,numerical.N-1] = well.constraint[1][0]*numerical.dt/(numerical.dx[0,0]* \
       numerical.dy[0,0]*reservoir.h*reservoir.phi[0,0])
     
    IC.P = np.loadtxt("Pss1.txt")
