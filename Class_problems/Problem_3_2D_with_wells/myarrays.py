    ...
    for l in range(0,numerical.N):
        if (l+1) % numerical.Nx != 1:  #not on left boundary     
            ...
            if 'Neumann' in BC.type[0]:
                ...
                #Q[l,0] = Q[l,0] + 2 * Thalf(l,l,'x',fluid,reservoir,numerical)* (BC.value[0][0] - (fluid.rho/144.0)*BC.depth[0][0])* 6.33E-3 #with gravity   
        ...
        if (l+1) % numerical.Nx != 0:  #not on right boundary
            ...
            if 'Neumann' in BC.type[1]:
                ...
                #Q[l,0] = Q[l,0] + 2 * Thalf(l,l,'x',fluid,reservoir,numerical) * (BC.value[1][0] - (fluid.rho/144.0)*BC.depth[1][0])* 6.33E-3  #with gravity  
