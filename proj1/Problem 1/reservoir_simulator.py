...
from postprocess import postprocess #for postprocessing
...
initial_plot(reservoir,numerical,P_plot[:,2],time[2])
initial_plot(reservoir,numerical,P_plot[:,1000],time[1000])
