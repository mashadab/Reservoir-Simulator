...
2D reservoir simulation: Plotting contours
...
def initial_plot(reservoir,numerical,P,time):
    ...
    ax1= plt.contourf(numerical.Xc, numerical.Yc,np.reshape(P, (numerical.Nx,numerical.Ny)),100,cmap=cm.coolwarm, antialiased=True)
    ...
    plt.savefig(f'reservoir_pressure{time}.png',bbox_inches='tight', dpi = 600)
